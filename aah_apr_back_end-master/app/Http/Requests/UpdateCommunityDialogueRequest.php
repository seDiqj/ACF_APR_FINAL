...
class UpdateCommunityDialogueRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'programInformation.cdName' => 
            ['required', 'string', 'min:1', 'max:255', Rule::unique('community_dialogues', 'name')->ignore($this->route('id'))],
